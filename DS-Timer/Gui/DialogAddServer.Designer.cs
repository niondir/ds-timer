namespace DS_Timer.Gui
{
	partial class DialogAddServer
	{
		...
		private void InitializeComponent()
		{
			...
			// txtUrl
			// 
			this.txtUrl.Location = new System.Drawing.Point(12, 64);
			...
			this.label2.Text = "Url: (z.B. http://www.die-staemme.de)";
			// 
			// btnSave
			// 
			...
			this.Name = "DialogAddServer";
			this.Text = "Server hinzufügen";
